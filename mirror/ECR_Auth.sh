...
aws configure --profile=GlobalECR set aws_access_key_id AKIA4QAUTQR6UD2P7GPF
aws configure --profile=GlobalECR set aws_secret_access_key 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
